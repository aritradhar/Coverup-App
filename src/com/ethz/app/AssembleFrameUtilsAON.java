...
public class AssembleFrameUtilsAON {
	...
	public static void assembleDropletsAON(String JSONDirPath, JFrame frame, byte[] decodedData_out, JTextArea textArea, JProgressBar progressBar, JButton btnNewButton)
	{
		if(JSONDirPath == null)
